  ...
  return (
    <div>
      ...
      >
        ...
        <div className="w-full md:pt-44 -mt-44 md:mt-0 mb-10 px-12 lg:max-w-[1250px]">
          ...
          <div className="container ml-4">
            <div className="flex flex-wrap">
              ...
              <div className="w-full md:w-1/3 mb-6">
                <a
                  href="/events"
                  className="text-xl font-bold hover:text-[#7EA8FF]"
                >
                  Events
                </a>
              ...
              <div className="w-full md:w-1/3 mb-6">
                <a
                  href="/competitions"
                  className="text-xl font-bold mb-4 hover:text-[#7EA8FF]"
                >
                  Competitions
                </a>
                <ul className="text-lg font-semibold mt-4">
