function Roadmap() {
  return (
    <div className="flex flex-col">
      <div className="text-[#FFE99E] flex justify-center text-5xl lg:text-8xl font-poppins font-bold mt-4 mb-7 min-[500px]:mt-10 min-[500px]:mb-16 min-[1000px]:mt-16 min-[1000px]:mb-20 text-shadow-3px md:text-shadow-5px ">
        ROADMAP
      </div>
      <div className="flex  justify-center mt-3">
        ...
        <div className="w-[80%] h-[100%] min-[700px]:hidden max-w-[1140px]">
          ...
          >
            <path
              d="M151.094,4C126.72,14.6291,-2.75383,8.94919,4.27578,89.1819C10.549,160.781,
                    208.17,202.4,279.52,259.546C320.997,292.765,316,358,181.5,455.5c-153.942,111.594-42.406,
                    163,66.5,178"
              transform="matrix(.881985 0 0 0.936528 18.082655 20.2317)"
              fill="none"
              stroke="#29375c"
              stroke-width="8"
            />
            ...
            >
              <div className="flex">
                <div className="text-xs font-poppins font-bold pl-0">
                  Company <br />
        ...
        <div className="w-[80%] h-[100%] hidden min-[700px]:block max-w-[1140px]">
          ...
          >
            <path
              d="M362.238,10.1797C247.759,24.1625,-19.7146,68.8174,13.3009,174.365C42.7639,
            ...
            >
              <div className="flex flex-col">
                ...
                <div className="text-[0.3rem] font-poppins font-bold pl-0">
                  Company <br />
                  <span className="ml-[6px]">Visit</span>
                </div>
              </div>
            </foreignObject>
            <foreignObject
