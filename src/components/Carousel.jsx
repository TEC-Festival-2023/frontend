  ...
  return (
    <div className="overflow-hidden">
      <div className="flex justify-center items-center bg-wavePhone bg-[length:100%_100%] sm:bg-vector11 sm:overflow-hidden h-[650px]">
        <div className="grid grid-cols-2 sm:justify-items-center mx-[5%] gap-10 font-poppins max-w-[1250px] h-full">
          {/* Kiri */}
          <div
            data-aos="fade-right"
            className="flex flex-col justify-center sm:mt-20 sm:mb-0 mb-20 overflow-y-scroll sm:h-[100%] sm:overflow-hidden basis-[100%] shrink-[1] grow-[1]"
          >
          ...
          <div
            data-aos="fade-left"
            className="mt-24 flex flex-col xs:w-3/4 sm:w-4/5 basis-[100%] shrink-[1] grow-[1]"
          >
