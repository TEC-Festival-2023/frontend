function CtaCompe() {
  return (
    <div className="mt-20 font-poppins font-bold flex flex-col sm:flex-row sm:justify-center">
      <div className="self-center bg-blobred bg-center bg-[length:75%] bg-no-repeat shrink">
        <button className="min-h-[300px] hover:scale-110 transition-all duration-300">
          <div className=" flex flex-col">
            ...
            />
            <div className="text-[50%] min-[375px]:text-[60%] min-[300px]:text-[65%] min-[400px]:text-xs sm:text-sm md:text-[0.9rem] shrink-[3] self-center white-shadow-1px sm:white-shadow-3px ">
              <br />
              Ready to Compete?
              <br />
              <br />
