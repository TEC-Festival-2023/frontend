  ...
  return (
    ...
    >
      ...
      <div
        ...
        `}
      >
        <div className="flex flex-col uppercase py-4 mt-20 cursor-pointer">
          <a
            href="/"
          ...
          <Accordion >
            <div className="bg-[#F8D660] flex py-8 hover:font-bold duration-100 border-b border-gray-600">
              <a
                href="/events"
                className="self-center ml-auto pl-14"
              >
                Events
              </a>
            ...
            <AccordionDetails
              ...
              <div className="flex flex-col">
                <a href="/events/tecfest-talks" className="flex justify-center py-3 ">
                  TECFest Talks
                </a>
                <hr className="border-slate-400" />
                <a href="/events/youth-entrepreneur-lab" className="flex justify-center py-3 ">
                  Youth Entrepreneur Lab
                </a>
                <hr className="border-slate-400" />
                <a href="/events/startup-expo" className="flex justify-center py-3">
                  Start-Up Expo
                </a>
                <hr className="border-slate-400" />
                <a href="/events/grand-summit" className="flex justify-center pt-3 pb-2">
                  Grand Summit
                </a>
              </div>
            </AccordionDetails>
          ...
          <Accordion >
            ...
            <AccordionDetails
              ...
              <div className="flex flex-col">
                <a href="/competitions/business-case" className="flex justify-center py-3 ">
                  Business Case Competition
                </a>
                <hr className="border-slate-400" />
                <a href="/competitions/business-plan" className="flex justify-center py-3 ">
                  Business Plan Competition
                </a>
