...
const Herocomp = () => {
  return (
    <div className='p-10 font-poppins text-center'>
      <h1 className='text-6xl discovery'>Discovery in</h1>
      <div className='flex mx-10 items-center justify-center -mt-6 pl-10'>
        <h1 className='text-7xl font-bold z-[1]'>TECFEST</h1>
        <div className='relative pt-14 -ml-10'>
          <h2 className='italic font-semibold -rotate-[20deg] absolute z-[1] mx-7 m-9 text-[#E26767] text-xl'>2022</h2>
          <img src="images/Star 1.png" className='w-24' alt="" />
        </div> 
      </div>
